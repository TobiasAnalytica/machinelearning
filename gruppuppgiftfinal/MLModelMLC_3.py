...
# 1) Load the data
data_path = "C:\\workspace\\book1.csv"  # Adjust if your CSV is somewhere else
...
param_grid = dict(clf__estimator__alpha=alpha_values)
...
threshold = 0.3  # Modify if needed
y_pred = (y_pred_proba >= threshold).astype(int)

accuracy = accuracy_score(y_test, y_pred)
print("Accuracy:", accuracy)

# Expose necessary objects for import
